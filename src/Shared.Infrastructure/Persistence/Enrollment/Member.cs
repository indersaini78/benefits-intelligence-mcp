...
public partial class Member
{
    ...
    public virtual ICollection<EnrollmentTransaction> EnrollmentTransactions { get; set; } = new List<EnrollmentTransaction>();
    ...
    public virtual ICollection<QualifyingLifeEvent> QualifyingLifeEvents { get; set; } = new List<QualifyingLifeEvent>();
}
